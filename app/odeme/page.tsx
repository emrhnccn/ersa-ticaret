      ...
      <div className="max-w-xl w-full bg-white rounded-3xl p-8 md:p-10 border border-slate-200 shadow-xl text-center space-y-6">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">
            Fiyat &amp; Sipariş Danışma
          </h1>
          <p className="text-sm text-slate-600 mt-2 leading-relaxed">
            Sipariş ve ödeme işlemleri doğrudan WhatsApp ve telefon üzerinden güvenle ve hızlıca gerçekleştirilmektedir.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          <a
            href="https://wa.me/905525843073?text=Merhaba,%20parça%20siparişi%20ve%20fiyat%20bilgisi%20almak%20istiyorum."
            target="_blank"
        ...
        <div className="pt-4 border-t border-slate-100 flex items-center justify-center">
          ...
          >
            <Package size={16} /> Parça Kataloğuna Dön <ArrowRight size={16} />
          </Link>
        </div>
      </div>
    </div>
